...
model = tf.keras.models.load_model('bird_sound_classification_model_3.h5')

# Define label encoder
classes = ['Brown_Tinamou', 'Cinereous_Tinamou', 'Great_Tinamou', 'other_birds']
...
def predict_bird_species(file_path, threshold=0.7):
